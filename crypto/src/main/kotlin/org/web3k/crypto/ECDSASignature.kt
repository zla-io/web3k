...
/**
 * Returns true if the S component is "low", that means it is below [HALF_CURVE_ORDER].
 *
 * See [BIP62](https://github.com/bitcoin/bips/blob/master/bip-0062.mediawiki#Low_S_values_in_signatures).
 */
fun ECDSASignature.isCanonical(): Boolean =
        s <= HALF_CURVE_ORDER
 ...
 */
fun ECDSASignature.toCanonical(): ECDSASignature =
        if (isCanonical()) {
            this
        } else {
